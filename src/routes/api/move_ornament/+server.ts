...
export const POST: RequestHandler = async ({ cookies, request }) => {
  ...
  const sqlInstruction = "INSERT INTO users(slack_id, username, pfp_url, ornament_position, last_moved_at) VALUES($1, $2, $3, $4, $5)"
  const values = [slack_id, profile.display_name, profile.image_192, ornamentPosStr, (new Date()).toISOString()]

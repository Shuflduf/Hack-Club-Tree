	...
	<form>
		...
		<div class="question red">
			...
			<div class="image-radio">
				...
				<label>
					<input type="radio" name="decoration-choice" value="2" />
					<img src="overlays/02_hearts.png" alt="Hearts" />
				</label>

				<label>
					<input type="radio" name="decoration-choice" value="3" />
					<img src="overlays/03_snowman.png" alt="Snowman" />
				</label>
				<label>
					<input type="radio" name="decoration-choice" value="4" />
					<img src="overlays/04_jolly.png" alt="Jolly" />
				</label>
				<label>
					<input type="radio" name="decoration-choice" value="5" />
					<img src="overlays/05_lights.png" alt="Lights" />
				</label>
				<label>
					<input type="radio" name="decoration-choice" value="6" />
